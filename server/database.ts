  ...
  async getVenueSettings(): Promise<VenueSettings> {
    ...
    if (settings) {
      return {
        ...
        gameSubtitleWhite: (settings as any).gameSubtitleWhite || "false",
        gameSubtitleBold: (settings as any).gameSubtitleBold || "false",
        gameSubtitleItalic: (settings as any).gameSubtitleItalic || "false",
        titleboxSpacing: (settings as any).titleboxSpacing || "20",
        gameSpacing: (settings as any).gameSpacing || "30",
    ...
    if (existingSettings) {
      ...
      const [updated] = await db.update(venueSettings)
        .set({
          ...
          gameSubtitleWhite: settings.gameSubtitleWhite !== undefined ? settings.gameSubtitleWhite : (existingSettings as any).gameSubtitleWhite,
          gameSubtitleBold: settings.gameSubtitleBold !== undefined ? settings.gameSubtitleBold : (existingSettings as any).gameSubtitleBold,
          gameSubtitleItalic: settings.gameSubtitleItalic !== undefined ? settings.gameSubtitleItalic : (existingSettings as any).gameSubtitleItalic,
          titleboxSpacing: settings.titleboxSpacing !== undefined ? settings.titleboxSpacing : (existingSettings as any).titleboxSpacing,
          gameSpacing: settings.gameSpacing !== undefined ? settings.gameSpacing : (existingSettings as any).gameSpacing,
      ...
      const updatedSettings: VenueSettings = {
        ...
        gameSubtitleWhite: (updated as any).gameSubtitleWhite || "false",
        gameSubtitleBold: (updated as any).gameSubtitleBold || "false",
        gameSubtitleItalic: (updated as any).gameSubtitleItalic || "false",
        titleboxSpacing: (updated as any).titleboxSpacing || "20",
        gameSpacing: (updated as any).gameSpacing || "30",
